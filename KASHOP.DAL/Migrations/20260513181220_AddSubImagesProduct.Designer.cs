...
namespace KASHOP.DAL.Migrations
{
    ...
    [Migration("20260513181220_AddSubImagesProduct")]
    partial class AddSubImagesProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KASHOP.DAL.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KASHOP.DAL.Models.OrderItem", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KASHOP.DAL.Models.OrderItem", b =>
                {
                    b.HasOne("KASHOP.DAL.Models.Order", "Order")
                        .WithMany("OrderItems")
